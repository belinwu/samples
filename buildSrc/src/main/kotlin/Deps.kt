object Vers {
    const val androidGradlePlugin = "3.4.0-beta01"
...
object Deps {
    ...
    const val core_ktx = "androidx.core:core-ktx:1.1.0-alpha03"
    const val activity = "androidx.activity:activity:1.0.0-alpha03"
    const val activity_ktx = "androidx.activity:activity-ktx:1.0.0-alpha03"
    const val appcompat = "androidx.appcompat:appcompat:1.1.0-alpha01"
    const val fragment = "androidx.fragment:fragment:1.1.0-alpha03"
    const val fragment_ktx = "androidx.fragment:fragment-ktx:1.1.0-alpha03"
    const val webkit = "androidx.webkit:webkit:1.0.0"
    const val lifecycle = "androidx.lifecycle:lifecycle-runtime:2.1.0-alpha01"
    const val lifecycle_extensions = "androidx.lifecycle:lifecycle-extensions:2.1.0-alpha01"
    const val viewmodel = "androidx.lifecycle:lifecycle-viewmodel:2.1.0-alpha01"
    const val viewmodel_ktx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.1.0-alpha01"
    const val livedata_core_ktx = "androidx.lifecycle:lifecycle-livedata-core-ktx:2.1.0-alpha01"
    const val livedata_ktx = "androidx.lifecycle:lifecycle-livedata-ktx:2.1.0-alpha01"
    const val lifecycle_compiler = "androidx.lifecycle:lifecycle-compiler:2.1.0-alpha01"
    const val room = "androidx.room:room-runtime:2.1.0-alpha03"
    const val room_coroutines = "androidx.room:room-coroutines:2.1.0-alpha03"
    const val room_compiler = "androidx.room:room-compiler:2.1.0-alpha03"
    const val sqlite_ktx = "androidx.sqlite:sqlite-ktx:2.0.0"
    const val paging = "androidx.paging:paging-runtime:2.1.0-rc01"
    const val paging_ktx = "androidx.paging:paging-runtime-ktx:2.1.0-rc01"
    const val paging_rxjava = "androidx.paging:paging-rxjava2:2.1.0-rc01"
    const val paging_rxjava_ktx = "androidx.paging:paging-rxjava2-ktx:2.1.0-rc01"
    const val navigation = "android.arch.navigation:navigation-runtime:1.0.0-alpha09"
    const val navigation_fragment = "android.arch.navigation:navigation-fragment:1.0.0-alpha09"
    const val navigation_ui = "android.arch.navigation:navigation-ui:1.0.0-alpha09"
    const val work = "android.arch.work:work-runtime:1.0.0-beta02"
    const val work_ktx = "android.arch.work:work-runtime-ktx:1.0.0-beta02"
    const val work_rxjava = "android.arch.work:work-rxjava2:1.0.0-beta02"
    const val work_testing = "android.arch.work:work-testing:1.0.0-beta02"
    const val espresso = "androidx.test.espresso:espresso-core:3.1.0-alpha1"
    ...
    const val collection = "androidx.collection:collection:1.1.0-alpha01"
    const val collection_ktx = "androidx.collection:collection-ktx:1.1.0-alpha01"
    ...
    const val media = "androidx.media:media:1.1.0-alpha01"
    const val media_widget = "androidx.media:media-widget:1.0.0-alpha06"
    const val media2 = "androidx.media2:media2:1.0.0-alpha04"
    const val mediarouter = "androidx.mediarouter:mediarouter:1.1.0-alpha01"
    ...
    const val preference_ktx = "androidx.preference:preference-ktx:1.1.0-alpha02"
    const val transition = "androidx.transition:transition:1.1.0-alpha01"
    ...
    const val textclassifier = "androidx.textclassifier:textclassifier:1.0.0-alpha01"
    ...
    const val leanback_preference = "androidx.leanback:leanback-preference:1.0.0"
    ...
    const val savedstate = "androidx.savedstate:savedstate-common:1.0.0-alpha01"
