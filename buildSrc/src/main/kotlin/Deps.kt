object Vers {
    const val androidGradlePlugin = "3.4.0-alpha06"
...
object Deps {
    ...
    const val navigation_runtime = "android.arch.navigation:navigation-runtime:${Vers.navigation}"
    const val navigation_fragment = "android.arch.navigation:navigation-fragment:${Vers.navigation}"
    ...
    const val slice_view = "androidx.slice:slice-view:${Vers.androidx}"
    ...
    const val ktor_client_android = "io.ktor:ktor-client-android:1.0.0"
    const val ktor_client_okhttp = "io.ktor:ktor-client-okhttp:1.0.0"
