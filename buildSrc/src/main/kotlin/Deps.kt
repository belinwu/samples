object Deps {
    ...
    const val activity = "androidx.activity:activity:1.0.0-alpha05"
    const val activity_ktx = "androidx.activity:activity-ktx:1.0.0-alpha05"
    const val appCompat = "androidx.appcompat:appcompat:1.1.0-alpha03"
    const val appCompatResources = "androidx.appcompat:appcompat-resources:1.1.0-alpha03"
    const val fragment = "androidx.fragment:fragment:1.1.0-alpha05"
    const val fragment_ktx = "androidx.fragment:fragment-ktx:1.1.0-alpha05"
    const val webkit = "androidx.webkit:webkit:1.0.0"
    const val lifecycle = "androidx.lifecycle:lifecycle-runtime:2.1.0-alpha03"
    const val lifecycle_extensions = "androidx.lifecycle:lifecycle-extensions:2.1.0-alpha03"
    const val viewmodel = "androidx.lifecycle:lifecycle-viewmodel:2.1.0-alpha03"
    const val viewmodel_ktx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.1.0-alpha03"
    const val viewModelSavedState = "androidx.lifecycle:lifecycle-viewmodel-savedstate:1.0.0-alpha01"
    const val livedata_core_ktx = "androidx.lifecycle:lifecycle-livedata-core-ktx:2.1.0-alpha03"
    const val livedata_ktx = "androidx.lifecycle:lifecycle-livedata-ktx:2.1.0-alpha03"
    const val lifecycle_compiler = "androidx.lifecycle:lifecycle-compiler:2.1.0-alpha03"
    ...
    const val navigation = "androidx.navigation:navigation-runtime:2.0.0"
    const val navigationFragment = "androidx.navigation:navigation-fragment:2.0.0"
    const val navigationUi = "androidx.navigation:navigation-ui:2.0.0"
    const val work = "androidx.work:work-runtime:2.0.0-rc01"
    const val work_ktx = "androidx.work:work-runtime-ktx:2.0.0-rc01"
    const val work_rxjava = "androidx.work:work-rxjava2:2.0.0-rc01"
    const val work_testing = "androidx.work:work-testing:2.0.0-rc01"
    ...
    const val dynamicanimation_ktx = "androidx.dynamicanimation:dynamicanimation-ktx:1.0.0-alpha01"
    const val biometric = "androidx.biometric:biometric:1.0.0-alpha03"
    const val browser = "androidx.browser:browser:1.0.0"
    const val collection = "androidx.collection:collection:1.1.0-alpha03"
    const val collection_ktx = "androidx.collection:collection-ktx:1.1.0-alpha03"
    ...
    const val media = "androidx.media:media:1.1.0-alpha02"
    const val media_widget = "androidx.media:media-widget:1.0.0-alpha06"
    const val media2 = "androidx.media2:media2:1.0.0-alpha04"
    const val mediarouter = "androidx.mediarouter:mediarouter:1.1.0-alpha02"
    ...
    const val transition = "androidx.transition:transition:1.1.0-alpha02"
