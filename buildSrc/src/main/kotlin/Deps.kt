object Deps {
    ...
    const val activityVersion = "1.1.0-alpha02"
    const val kotlinVersion = "1.3.50-eap-54"
    const val ktorVersion = "1.2.3-rc"
    const val workVersion = "2.2.0"
    const val navigationVersion = "2.2.0-alpha01"
    const val pagingVersion = "2.1.0"
    const val roomVersion = "2.2.0-alpha02"
    const val lifecycleVersion = "2.2.0-alpha03"
    const val coroutinesVersion = "1.3.0-RC2"
    const val adsIdVersion = "1.0.0-alpha01"
    const val listenableFutureVersion = "1.0.0-rc01"
    const val coreVersion = "1.2.0-alpha03"
    const val fragmentVersion = "1.2.0-alpha02"
    ...
    const val cameraCore = "androidx.camera:camera-core:1.0.0-alpha04"
    const val cameraCamera2 = "androidx.camera:camera-camera2:1.0.0-alpha04"
    const val cameraView = "androidx.camera:camera-view:1.0.0-alpha01"
    const val cameraExtensions = "androidx.camera:camera-extensions:1.0.0-alpha01"
    ...
    const val viewModelSavedState = "androidx.lifecycle:lifecycle-viewmodel-savedstate:1.0.0-alpha03"
    ...
    const val firebaseStorage = "com.google.firebaAppGlideModulese:firebase-storage:17.0.0"
