object Deps {
    ...
    const val cameraCore = "androidx.camera:camera-core:1.0.0-alpha03"
    const val cameraCamera2 = "androidx.camera:camera-camera2:1.0.0-alpha03"
    ...
    const val activityKtx = "androidx.activity:activity-ktx:1.1.0-alpha01"
    const val appCompat = "androidx.appcompat:appcompat:1.1.0-rc01"
    const val appCompatResources = "androidx.appcompat:appcompat-resources:1.1.0-rc01"
    const val autofill = "androidx.autofill:autofill:1.0.0-alpha01"
    ...
    const val lifecycle = "androidx.lifecycle:lifecycle-runtime:2.2.0-alpha02"
    const val lifecycleExtensions = "androidx.lifecycle:lifecycle-extensions:2.2.0-alpha02"
    const val lifecycleReactiveStreams = "androidx.lifecycle:lifecycle-reactivestreams-ktx:2.2.0-alpha02"
    const val viewModel = "androidx.lifecycle:lifecycle-viewmodel:2.2.0-alpha02"
    const val viewModelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.2.0-alpha02"
    const val viewModelSavedState = "androidx.lifecycle:lifecycle-viewmodel-savedstate:1.0.0-alpha02"
    const val liveDataCoreKtx = "androidx.lifecycle:lifecycle-livedata-core-ktx:2.2.0-alpha02"
    const val liveDataKtx = "androidx.lifecycle:lifecycle-livedata-ktx:2.2.0-alpha02"
    const val lifecycleCompiler = "androidx.lifecycle:lifecycle-compiler:2.2.0-alpha02"
    const val room = "androidx.room:room-runtime:2.2.0-alpha01"
    const val roomKtx = "androidx.room:room-ktx:2.2.0-alpha01"
    const val roomMigration = "androidx.room:room-migration:2.2.0-alpha01"
    const val roomCoroutines = "androidx.room:room-coroutines:2.1.0-alpha04"
    const val roomCompiler = "androidx.room:room-compiler:2.2.0-alpha01"
    ...
    const val pagingRxJava = "androidx.paging:paging-rxjava2:2.1.0"
    const val pagingRxJavaKtx = "androidx.paging:paging-rxjava2-ktx:2.1.0"
    const val navigation = "androidx.navigation:navigation-runtime-ktx:2.1.0-beta01"
    const val navigationFragment = "androidx.navigation:navigation-fragment-ktx:2.1.0-beta01"
    const val navigationUi = "androidx.navigation:navigation-ui-ktx:2.1.0-beta01"
    const val work = "androidx.work:work-runtime:2.2.0-beta01"
    const val workKtx = "androidx.work:work-runtime-ktx:2.2.0-beta01"
    const val workRxJava = "androidx.work:work-rxjava2:2.2.0-beta01"
    const val workTesting = "androidx.work:work-testing:2.2.0-beta01"
    ...
    const val listenableFuture = "androidx.concurrent:concurrent-listenablefuture:1.0.0-beta01"
    const val listenableFutureCallback = "androidx.concurrent:concurrent-listenablefuture-callback:1.0.0-beta01"
    ...
    const val media2Widget = "androidx.media2:media2-widget:1.0.0-beta01"
    const val media2Common = "androidx.media2:media2-common:1.0.0-rc01"
    const val media2Session = "androidx.media2:media2-session:1.0.0-rc01"
    const val media2Player = "androidx.media2:media2-player:1.0.0-rc01"
    ...
    const val transition = "androidx.transition:transition:1.2.0-beta01"
    const val versionedParcelable = "androidx.versionedparcelable:versionedparcelable:1.1.0-rc01"
    const val vectorDrawable = "androidx.vectordrawable:vectordrawable:1.1.0-rc01"
    const val vectorDrawableAnimated = "androidx.vectordrawable:vectordrawable-animated:1.1.0-rc01"
    ...
    const val savedState = "androidx.savedstate:savedstate:1.0.0-rc01"
    const val viewPager2 = "androidx.viewpager2:viewpager2:1.0.0-beta01"
    ...
    const val kotlinStdlibJdk8 = "org.jetbrains.kotlin:kotlin-stdlib-jdk8:$kotlin"
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:$kotlin"
    const val kotlinScripting = "org.jetbrains.kotlin:kotlin-scripting-jvm:$kotlin"
    const val coroutinesCore = "org.jetbrains.kotlinx:kotlinx-coroutines-core-common:1.3.0-RC"
    const val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.3.0-RC"
    ...
    const val rxJava3 = "io.reactivex.rxjava3:rxjava:3.0.0-RC1"
