object Vers {
    const val androidGradlePlugin = "3.4.0-alpha07"
...
object Deps {
    ...
    const val activity = "androidx.activity:activity:1.0.0-alpha02"
    const val activity_ktx = "androidx.activity:activity-ktx:1.0.0-alpha02"
    const val appcompat = "androidx.appcompat:appcompat:1.1.0-alpha01"
    const val fragment = "androidx.fragment:fragment:1.1.0-alpha02"
    const val fragment_ktx = "androidx.fragment:fragment-ktx:1.1.0-alpha02"
    const val webkit = "androidx.webkit:webkit:1.0.0"
    const val lifecycle = "androidx.lifecycle:lifecycle-runtime:2.0.0"
    ...
    const val navigation = "android.arch.navigation:navigation-runtime:1.0.0-alpha08"
    const val navigation_fragment = "android.arch.navigation:navigation-fragment:1.0.0-alpha08"
    const val navigation_ui = "android.arch.navigation:navigation-ui:1.0.0-alpha08"
    const val work = "android.arch.work:work-runtime:1.0.0-alpha12"
    const val work_rxjava = "android.arch.work:work-rxjava2:1.0.0-alpha12"
    const val work_testing = "android.arch.work:work-testing:1.0.0-alpha12"
    ...
    const val databinding = "androidx.databinding:databinding-runtime:3.4.0-alpha06"
    const val databinding_adapters = "androidx.databinding:databinding-adapters:3.4.0-alpha06"
    ...
    const val glide_compiler = "com.github.bumptech.glide:compiler:${Vers.glide}"
    const val junit = "junit:junit:${Vers.junit}"
    const val simplecropview = "com.isseiaoki:simplecropview:1.1.8"
    const val anko_commons = "org.jetbrains.anko:anko-commons:${Vers.anko}"
    const val anko_sqlite = "org.jetbrains.anko:anko-sqlite:${Vers.anko}"
    ...
    const val ktor_client_android = "io.ktor:ktor-client-android:1.0.1"
    const val ktor_client_okhttp = "io.ktor:ktor-client-okhttp:1.0.1"
