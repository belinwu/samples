...
object Dep {
    // versions
    const val androidGradleVersion = "4.0.0-rc01"
    const val compileSdkVersion = 29
    const val targetSdkVersion = 29
    const val minSdkVersion = 21
    const val buildToolsVersion = "29.0.2"
    const val activityVersion = "1.2.0-alpha04"
    const val appCompatVersion = "1.2.0-rc01"
    const val kotlinVersion = "1.4-M1"
    const val ktorVersion = "1.3.2-1.4-M1"
    const val workVersion = "2.4.0-alpha03"
    const val navigationVersion = "2.3.0-alpha06"
    const val pagingVersion = "2.1.2"
    const val roomVersion = "2.2.5"
    const val lifecycleVersion = "2.3.0-alpha02"
    const val coroutinesVersion = "1.3.5-1.4-M1"
    const val adsIdVersion = "1.0.0-alpha04"
    const val listenableFutureVersion = "1.0.0-beta01"
    const val coreVersion = "1.3.0-rc01"
    const val fragmentVersion = "1.3.0-alpha04"
    const val coilVersion = "0.9.5"
    const val media2Version = "1.0.2"
    const val sqliteVersion = "2.1.0"
    const val windowVersion = "1.0.0-alpha01"
    const val cameraVersion = "1.0.0-beta03"
    const val cameraViewVersion = "1.0.0-alpha10"
    const val emojiVersion = "1.1.0-rc01"
    const val exoPlayerVersion = "2.11.4"
    const val dataBindingVersion = "4.1.0-alpha05"
    const val composeVersion = "0.1.0-dev11"
    const val frescoVersion = "2.2.0"
    ...
    const val benchmark = "androidx.benchmark:benchmark-common:1.0.0"
    ...
    const val customView = "androidx.customview:customview:1.1.0-beta01"
    ...
    const val concurrentFutures = "androidx.concurrent:concurrent-futures-ktx:1.1.0-alpha01"
    ...
    const val media = "androidx.media:media:1.2.0-alpha02"
    ...
    const val mediaRouter = "androidx.mediarouter:mediarouter:1.2.0-alpha01"
    ...
    const val slidingPaneLayout = "androidx.slidingpanelayout:slidingpanelayout:1.1.0-beta01"
    const val drawerLayout = "androidx.drawerlayout:drawerlayout:1.1.0-beta01"
    const val preference = "androidx.preference:preference-ktx:1.1.1"
    const val transition = "androidx.transition:transition:1.3.0"
    ...
    const val securityCrypto = "androidx.security:security-crypto:1.0.0-rc01"
    ...
    const val uiCore = "androidx.ui:ui-core:$composeVersion"
    const val uiLayout = "androidx.ui:ui-layout:$composeVersion"
    const val uiMaterial = "androidx.ui:ui-material:$composeVersion"
    const val uiMaterialIconsExtended = "androidx.ui:ui-material-icons-extended:$composeVersion"
    const val uiFoundation = "androidx.ui:ui-foundation:$composeVersion"
    const val uiAnimation = "androidx.ui:ui-animation:$composeVersion"
    const val uiLiveData = "androidx.ui:ui-livedata:$composeVersion"
    const val uiSavedState = "androidx.ui:ui-saved-instance-state:$composeVersion"
    const val uiVector = "androidx.ui:ui-vector:$composeVersion"
    const val uiText = "androidx.ui:ui-text:$composeVersion"
    const val uiTextAndroid = "androidx.ui:ui-text-android:$composeVersion"
    const val uiUtil = "androidx.ui:ui-util:$composeVersion"
